import { Box, Button, Container, Heading, HStack, Spinner, Text, useBreakpointValue, VStack } from '@chakra-ui/react';
...
const ViewFeedback = () => {
    ...
    const { questionText, isLoading, getFeedback, getEmotion, clearLocalStorage, feedbackText, emotionValue } = useAppContext();
            ...
            <VStack spacing={6} align="stretch">
                <Box bg="blue.500" p={2} rounded="md" color="white" textAlign="center">
                    <Heading as="h1" size="md">
                        {questionText || "Result is pending"}
                    </Heading>
                </Box>
                <HStack spacing={6} align="start" flexDirection={isMobile ? 'column' : 'row'}>
                    <Box flex={2} bg="gray.100" p={4} rounded="md" shadow="md" overflow="auto" maxH="60vh">
